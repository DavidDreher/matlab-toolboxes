...
fprintf('Mexing wavelet toolbox');

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% JPEG2000
warning('Disabled: Jpeg200 mex files')
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% LIW atrou
warning('Disabled: trou wavelet transforms mex files')
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% RWT
warning('Disabled: rice wavelet toolbox mex files')
% 
